 ...
 */
export function roomApiDev() {
    var store = new MemoryStore();
    return {
        name: 'room-api-dev',
        configureServer: function (server) {
            var _this = this;
            server.middlewares.use('/api/room', function (req, res) {
                if (req.method !== 'POST') {
                    res.statusCode = 405;
                    res.end();
                    return;
                ...
                var raw = '';
                req.on('data', function (chunk) { return (raw += chunk); });
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                ...
                                return [4 /*yield*/, handleRoom(store, payload)];
                            case 1:
                                result = _a.sent();
